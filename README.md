...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5yweyew.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5yweyew.containers.anotherwebservice.com/
...
```
git clone git@github.com:MmingY/container-5yweyew.git
cd container-5yweyew
```
...
```
docker attach container-5yweyew
```
